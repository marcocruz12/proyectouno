...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    ...
    <?php if(!$isColor){ ?>
    <h1 style="background-color:red;" class="p-3 mb-2 bg-success text-white text-center mt-5">Hola mundo : FALSE</h1>
    <?php 
    } else {
    ?>
     <h1 style="background-color:green;" class="p-3 mb-2 bg-success text-white text-center mt-5">Hola mundo : TRUE</h1>
